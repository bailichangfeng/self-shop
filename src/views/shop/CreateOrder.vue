<template>
  <div class="create-order">
    ...
    <div class="good">
      <div v-for="(item, index) in state.cartList" :key="index" class="good-item">
...
import { getByCartItemIds, getDefaultAddress, getAddressDetail, createOrder, payOrder } from "@/api/shop";
